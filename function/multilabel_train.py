...
#         train_predictions += train_predictions + out1
    ...
    return total_loss,total_loss / total_examples,train_pre,train_label
...
task_names = get_task_names('data/precessed/raw/clintox.csv')
...
for train_index, val_index in kf.split(train_data):
    ...
    test_loader = DataLoader(val_fold, batch_size=32, shuffle=True)
    ...
    for epoch in range(epochs):
        ...
        train_loss, train_acc,pre2,label2= train(model1, optimizer, test_loader)
        ...
        if epoch == 300 :
           ...
           # output1.to_csv("outpot/clintox_loss_curve.csv")
            # print(output)
